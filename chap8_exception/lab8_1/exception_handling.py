...
try:
      ...
      print("pls provide a name as arg")
      sys.exit()
...
try: 
      ...
      print("pls provide a name and a number")
      sys.exit(1)
except ValueError:
      print("Error:the repeat count should be a number")
      sys.exit(1)
...
try:
      ...
      print("error: unable to write the file(",err,")")
